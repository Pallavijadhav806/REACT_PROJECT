...
const initialOrders = [
    { id: 1, orderId: 'ORD001', customerName: 'lily', orderDate: '2024-03-09', status: 'Pending' },
    { id: 2, orderId: 'ORD002', customerName: 'jony', orderDate: '2024-03-10', status: 'Processing' },
];
    ...
    return (
        <div className="orders-page">
            <div className="nav">
                ...
                <button onClick={addCustomer}><FontAwesomeIcon icon={faUserPlus} /> Add Orders</button>
            </div>
            ...
            {selectedOrder && (
                <div className="modal">
                    ...
                    <button onClick={addCustomer}><FontAwesomeIcon icon={faUserPlus} /> Add Order</button>
                </div>
            )}
            {showAddCustomerModal && (
                <AddCustomerModal addOrd={addOrd} closeModal={closeModal} />
            )}
            <MyCalendar/>
        </div>
    );
